...
namespace AwesomeizeCS.Data.Migrations
{
    ...
    [Migration("20240516185353_added-code-version")]
    partial class addedcodeversion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.CodeVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("CodeForId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("CodeForId");

                    b.ToTable("CodeVersion");
                });
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.IOTest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.TestResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.TestStep", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid?>("IOTestId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<int>("Order")
                        .HasColumnType("int");

                    b.Property<string>("ProvidedInput")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.CodeVersion", b =>
                {
                    b.HasOne("AwesomeizeCS.Domain.StudentAssignment", "CodeFor")
                        .WithMany()
                        .HasForeignKey("CodeForId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CodeFor");
                });
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.TestResult", b =>
                {
                    b.HasOne("AwesomeizeCS.Domain.CodeVersion", null)
                        .WithMany("Results")
                        .HasForeignKey("CodeVersionId");

                    b.HasOne("AwesomeizeCS.Domain.IOTest", "Test")
                        .WithMany()
            ...
            modelBuilder.Entity("AwesomeizeCS.Domain.TestStep", b =>
                {
                    b.HasOne("AwesomeizeCS.Domain.IOTest", "IOTest")
                        .WithMany("Steps")
                        .HasForeignKey("IOTestId");
