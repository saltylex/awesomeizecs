        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfSeminars = table.Column<int>(type: "int", nullable: false),
                    NumberOfLabs = table.Column<int>(type: "int", nullable: false),
                    DefaultCourseAttendanceTracking = table.Column<int>(type: "int", nullable: false),
                    DefaultSeminarAttendanceTracking = table.Column<int>(type: "int", nullable: false),
                    DefaultLaboratoryAttendanceTracking = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VisibleFromWeek = table.Column<int>(type: "int", nullable: false),
                    SolvableFromWeek = table.Column<int>(type: "int", nullable: false),
                    SolvableToWeek = table.Column<int>(type: "int", nullable: false),
                    Type = table.Column<int>(type: "int", nullable: false),
                    HasGrade = table.Column<bool>(type: "bit", nullable: false),
                    Bonus = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
                    HasParrent = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Order = table.Column<int>(type: "int", nullable: false),
                    AcademicYear = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ToughtBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    SpecificAttendanceTracking = table.Column<int>(type: "int", nullable: true),
                    CourseId = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    AttendingGroup = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Attendance_StudentCourse_StudentCourseId",
                        column: x => x.StudentCourseId,
                        principalTable: "StudentCourse",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendance_TimeTable_TimeId",
                        column: x => x.TimeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendance_StudentCourseId",
                table: "Attendance",
